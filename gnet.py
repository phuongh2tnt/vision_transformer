...
if __name__ == "__main__":
   ...
   #me tric moi
    ...
    for epoch in range(epochs):
        ...
        if val_acc > max_acc:
            ...
            torch.save(model.state_dict(),'/content/drive/My Drive/AI/el/gcheckpoints/2epoch_' + str(epoch) + '_acc_{0:.4f}'.format(max_acc) + '.pt')
            max_acc = val_acc
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('/content/drive/My Drive/AI/el/gcheckpoints/train_acc.png')
    plt.show()
    # Plotting
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('/content/drive/My Drive/AI/el/gcheckpoints/val_acc.png')
    plt.show()
    # Plotting
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('/content/drive/My Drive/AI/el/gcheckpoints/acc.png')
    plt.show()
    #---------------------------------------------
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('/content/drive/My Drive/AI/el/gcheckpoints/train_loss.png')
    plt.show()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('/content/drive/My Drive/AI/el/gcheckpoints/loss.png')
    plt.show()
    #---------------------------------------------
    # Plot
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('/content/drive/My Drive/AI/el/gcheckpoints/val_loss.png')
    plt.show()
   ...
   #-----------------------metric moi-----------
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('/content/drive/My Drive/AI/el/gcheckpoints/train_pre.png')
    plt.show()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('/content/drive/My Drive/AI/el/gcheckpoints/val_pre.png')
    plt.show()
      #-----------------
      #---------ve hai do thi --------------
    plt.subplot(2, 2, 2)
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('/content/drive/My Drive/AI/el/gcheckpoints/pre.png')
    plt.show()
    #---------------------------------------------
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('/content/drive/My Drive/AI/el/gcheckpoints/rec_train.png')
    plt.show()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('/content/drive/My Drive/AI/el/gcheckpoints/rec_val.png')
    plt.show()
       #-----------------
    #---------ve hai do thi --------------
    plt.subplot(2, 2, 2)
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('/content/drive/My Drive/AI/el/gcheckpoints/rec.png')
    plt.show()
    #---------------------------------------------
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('/content/drive/My Drive/AI/el/gcheckpoints/f1score_train.png')
    plt.show()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('/content/drive/My Drive/AI/el/gcheckpoints/f1_val.png')
    plt.show()
    #plt.savefig('/content/drive/My Drive/AI/el/gcheckpoints/trainacc2.png')
    #---------ve hai do thi --------------
    plt.subplot(2, 2, 2)
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('/content/drive/My Drive/AI/el/gcheckpoints/f1.png')
    plt.show()
    #---------------------------------------------
    #plt.show()
